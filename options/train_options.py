...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--position_based_range', type = int, default = 30, help = 'Define the range for the position-based selection strategy (PBS). In percentage')
        ...
        parser.add_argument('--report_wandb', action='store_true', help = 'Define if you want to submit results to WANDB')
        self.isTrain = True
        return parser
