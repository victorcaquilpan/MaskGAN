...
if __name__ == '__main__':
    ...
    opt.position_based_range = -99
    opt.display_id = -1   # no visdom display; the test code saves the results to a HTML file.
    opt.results_dir = '../../data/intermediate_2d_images'
    ...
    for phase in ['train','val', 'test']:   
        ...
        # Generate folders
        real_B_path = f'{opt.results_dir}/{opt.name}/{opt.phase}/real_B'
        real_A_path = f'{opt.results_dir}/{opt.name}/{opt.phase}/real_A'
        fake_B_path = f'{opt.results_dir}/{opt.name}/{opt.phase}/fake_B'
        fake_A_path = f'{opt.results_dir}/{opt.name}/{opt.phase}/fake_A'
