...
parser.add_argument('--results_folder', default='results/unsupervised_secondstage_goodimages_2nd/', help='path to intermediate results (2nd stage)')
parser.add_argument('--final_voxels_folder', default='thirdstage_final_results_goodimages/', help='path to leave input of 2nd stage')
